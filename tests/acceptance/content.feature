Feature: Test that pages have correct content
  ...
  Scenario: User create a new post
    Given I am on the new post page
    When I enter "My Post" in the "title" field
    And I enter "Random Content" in the "content" field
    And I press the submit button
    Then I am on the blog page
    Given I wait for the posts to load
    Then I can see there is a post with title "My Post" in the posts section

  Scenario: Seeing all posts
    Given I am on the blog page
